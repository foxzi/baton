...
type Error struct {
	...
	// that the message says what the provider complained about. It goes
...
// specification calls transient are worth retrying, the rest are not. 401 and
// 403 are a misconfigured key rather than a bad request.
